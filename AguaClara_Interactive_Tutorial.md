...
My name is Jonathan Harris and I'm a third year Environmental Engineering student.
...
![VSC](https://github.com/jdh345/PersonalAC/blob/master/Images/vfiles39917.jpg?raw=true)
...
As a major within the endowed College of Agriculture and Life Sciences, the Department of Biological and Environmental Engineering has a great ability to have a real impact on improving the lives of citizens in New York State. It's website can be found [here](http://bee.cals.cornell.edu/home).
...
|:------------ | ----------:|:------------:|:---------------- |
| Sloths       | Fried Fish | Harry Potter | Design Lab       |
| Wels Catfish | Curry goat |    Bible     | Duffield         |
| Polar Bears |Calalloo & Saltfish|Aristotle and Dante Discover The Secrets Of The Universe|Loft 2 in WSH|
...
The difference is how they run. The first leaves the cursor on that line, the second moves down to the next line, and the last allows you to run multiple lines at once.
...
if x==1:
  ...
  print('The value of x is not 1 or 10')
```
...
def Diffusion(kB,T,eta,r):
  return (kB*T.to(u.degK))/(6*math.pi*eta*r.to(u.m))

T = 40*u.degC
r = 0.2*u.cm
eta = pc.viscosity_dynamic(Temp)
Diffusion(kB,T,eta,r)
```
...
Q = 2*u.m**3/u.s
Temprange = range(200)
Temparray = np.array(Temprange)
Temp = Temparray*u.degC
Nu = pc.viscosity_kinematic(Temp)
Re = pc.re_pipe(Q,2*r,Nu)
plt.plot(Temp.to(u.degK),Re)
...
Hola Jonathan- thanks for tolerating my freshman-ness as I get used to the team. Also, thanks for your flexibility & helpfulness; you're a great subteam lead. -Tommy

Hi Jonathan, I'm super excited to have you on Filter Constrictions this semester! I think our team will be cohesive and productive! Look forward to working with you Best, Jackie
...
Jackie - 9435fafb-e351-4c77-bff1-b34ad17eca03
Tommy - c050fff6-3d66-4b35-8b60-bfbfe3a925cb
